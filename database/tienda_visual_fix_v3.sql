...
UPDATE store_builder SET visible=1, x=0, y=0, ancho=1000, alto=53, texto='Menú principal', color_fondo='#111827', color_texto='#ffffff', orden=5 WHERE componente='menu';
